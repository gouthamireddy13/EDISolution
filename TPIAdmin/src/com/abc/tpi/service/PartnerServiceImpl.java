...
public class PartnerServiceImpl implements PartnerService {
	...
	@Override
	public List<PartnerNameProjection> getAllPartnerNames() {
		return partnerRepository.findAllByOrderByPartnerName();
	}

	@Override
	public Partner findPartnerByUniqueName(String name) {
		return partnerRepository.findFirstByPartnerNameIgnoreCase(name);
	}
