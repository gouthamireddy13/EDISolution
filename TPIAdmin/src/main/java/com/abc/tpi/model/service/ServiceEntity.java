...
public abstract class ServiceEntity extends TpiManagedEntity {
	...
	//@NotNull
	@ManyToOne
	@JoinColumn(name="SEGMENT_DELIM", nullable=true)
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private Delimiter segmentDelimiter;
	
	//@NotNull
	@ManyToOne
	@JoinColumn(name="ELEMENT_DELIM", nullable=true) //added nullable param
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private Delimiter elementDelimiter;
	
	//@NotNull
	@ManyToOne
	@JoinColumn(name="COMPOSITE_DELIM", nullable=true) //added nullable param
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private Delimiter compositeElementDelimiter;
	
	@ManyToOne
	@JoinColumn(name="REPEAT_DELIM", nullable=true) //added nullable param
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	...
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private SdBusinessSubUnit sdBusinessSubUnitId;
	
	
	
	
	public SdBusinessSubUnit getSdBusinessSubUnitId() {
		return sdBusinessSubUnitId;
	}

	public void setSdBusinessSubUnitId(SdBusinessSubUnit sdBusinessSubUnitId) {
		this.sdBusinessSubUnitId = sdBusinessSubUnitId;
	}
