...
public interface ServiceSubscriptionService {
	...
	boolean saveServiceCategoryInProd(ServiceCategory serviceCategory, LightWellPartner lightWellPartner);
	...
	List<BusinessServiceWithParentInfo> findBusinessServiceWithParentBySrIdContainsIgnoreCase(String srId);
	List<BusinessServiceWithParentInfo> findBusinessServiceWithParentByPartnerName(String partnerName);
	List<BusinessServiceWithParentInfo> findBusinessServiceWithParentByPartnerNameContainsIgnoreCase(String partnerName);
