...
import com.abc.tpi.service.CommonJpaServiceImpl;
...
public class TestTpiMigratorTest {
	...
	@Autowired
	CommonJpaServiceImpl commonJpaService;
	...
	public void testGetBusinessServiceForMigrationGraph()
	{
		...
		ServiceCategory sc = commonJpaService.findGenericEntityUsingEntityGrpah(ServiceCategory.class, businessService.getServiceType().getServiceCategory().getId(), "ServiceCategory.graphLW");
