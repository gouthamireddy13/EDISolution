...
public interface ServiceTypeRepository extends JpaRepository<ServiceType, Long> {
	...
	List<ServiceType> namedFindServiceTypesForServiceCategoryAndTransaction
		(@Param("serviceCategoryId") long scId,@Param("directionId") long directionId,@Param("documentId") long documentId);
	
	List<ServiceType> namedFindServiceTypesForServiceCategoryAndTransactionDocumentAll
		(@Param("serviceCategoryId") long scId,@Param("directionId") long directionId);
